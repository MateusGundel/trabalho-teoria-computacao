...
class Passo4 {
    ...
    private static LinkedList<InstRotuladaComp> irPrograma1;
    ...
    public static LinkedList<InstRotuladaComp> getIrPrograma1() {
        return irPrograma1;
    }

    public static void setIrPrograma1(LinkedList<InstRotuladaComp> irPrograma1) {
        Passo4.irPrograma1 = irPrograma1;
    }

    public static LinkedList<InstRotuladaComp> getIrPrograma2() {
        return irPrograma2;
    }

    public static void setIrPrograma2(LinkedList<InstRotuladaComp> irPrograma2) {
